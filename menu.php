<header class="Header -is-sticky">
  <div class="Header_top -container">
    ...
    <div class="Header_quickLinks">
      <a class="Btn -with-icon" href="#"><span class="Btn_label Btn_bold">Home Comfort</span></a>
